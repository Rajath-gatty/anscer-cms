    ...
    >
      <ScrollReveal>
        <div className="site-container">
          <div className="max-w-190 3xl:max-w-[900px] 4xl:max-w-[1100px]">
            ...
            <p className="mt-4 max-w-170 3xl:max-w-[830px] 4xl:max-w-[1000px] text-sm leading-5 text-[#3a3a3a] md:text-[clamp(16px,0.8vw,30px)] 3xl:text-[clamp(20px,0.9vw,28px)] md:leading-[150%]">
