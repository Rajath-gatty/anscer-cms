...
function SolutionSlide({
  ...
  return (
    <article
      className={cn(
        "grid min-h-[584px] pt-10 items-start [@media(min-width:1384px)_and_(min-height:744px)]:mt-[5%] gap-6 bg-[#fafafa] transition-[transform,opacity] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-[transform,opacity] lg:grid-cols-2",
        "absolute inset-0",
      )}
      style={{
        opacity,
...
function ProgressRail({
  ...
  return (
    <div className="absolute right-2 top-[170px] [@media(min-width:1384px)_and_(min-height:744px)]:mt-[6%] [@media(min-width:1384px)_and_(min-height:744px)]:right-0 z-30 flex w-[56px] justify-center">
