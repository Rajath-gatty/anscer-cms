  ...
  return (
    <section className="relative flex h-[580px] 3xl:h-[720px] 4xl:h-[850px] items-center overflow-hidden bg-[#005ead] text-white max-[991px]:mt-5">
      ...
      <div className="site-container relative z-20">
        <FadeUp className="flex max-w-[970px] 3xl:max-w-[1100px] 4xl:max-w-[1300px] flex-col items-start gap-6 max-[991px]:gap-2">
          <h2 className="max-w-[970px] 3xl:max-w-[1100px] 4xl:max-w-[1300px] text-[48px] font-semibold leading-[60px] text-white md:text-[clamp(48px,4vw,80px)] md:leading-[110%]">
            Experience automation that understands your operations.
          </h2>
          <p className="max-w-[850px] 3xl:max-w-[1000px] 4xl:max-w-[1200px] text-sm leading-5 text-white md:text-[clamp(16px,0.8vw,30px)] 3xl:text-[clamp(20px,0.9vw,28px)] md:leading-[150%]">
