        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-2">
          <FadeUp className="order-2 flex flex-col overflow-hidden border border-[#005ead]/20 lg:order-1">
            <div className="flex flex-col border-b border-[#005ead]/20 lg:flex-row">
              <div className="group flex flex-1 flex-col gap-2.5 border-b border-[#005ead]/20 duration-300 transition-colors hover:bg-[#005EAD]/5 p-6 3xl:p-8 4xl:p-10 lg:border-b-0 lg:border-r">
                ...
                <p className="text-sm md:text-[clamp(14px,0.7vw,24px)] 3xl:text-[clamp(16px,0.8vw,28px)] leading-[130%] text-[#000000]">
                  Separates business logic from robot control logic
                </p>
              </div>
              <div className="group flex flex-1 flex-col gap-2.5 duration-300 transition-colors hover:bg-[#005EAD]/5 p-6 3xl:p-8 4xl:p-10">
                <div className="flex size-10 items-center justify-center rounded-[8px] bg-brand-navy/5 text-[#011f40] transition-all duration-300 group-hover:bg-[#005EAD]">
                  <ExternalLink
                    className="size-5 transition-colors duration-300 group-hover:text-white"
                    strokeWidth={1.7}
            ...
            <div className="group flex flex-col gap-6 p-6 3xl:p-8 4xl:p-10 lg:flex-row lg:items-center duration-300 transition-colors hover:bg-[#005EAD]/5">
