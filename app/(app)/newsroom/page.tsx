...
export default function NewsroomPage() {
  return (
    <main className="bg-[#fafafa] text-[#011f40]">
      {/* ══ 1. HERO ════════════════════════════════════════════════════════ */}
      <section className="h-[580px] 3xl:h-[720px] 4xl:h-[850px] relative">
        <Image
        ...
        <FadeUp className="site-container absolute inset-0 z-[2] flex flex-col justify-center items-start h-full pb-12">
          <div className="flex flex-col gap-6 max-w-[732px] leading-[110%]">
            ...
            <p className="text-[18px] md:text-[clamp(16px,0.8vw,30px)] 3xl:text-[clamp(20px,0.9vw,28px)] font-medium text-white m-0">
      ...
      {/* ══ 5. BANNER CTA ══════════════════════════════════════════════════ */}
      <section className="relative w-full h-[580px] 3xl:h-[720px] 4xl:h-[850px] flex overflow-hidden">
