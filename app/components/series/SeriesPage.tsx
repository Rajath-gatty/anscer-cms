        ...
        <div className="relative ml-auto flex min-h-[360px] w-full items-center justify-end lg:min-h-[520px]">
          <div className="relative h-[340px] w-full max-w-[760px] md:h-[440px] lg:h-[560px]">
            <Image
              ...
              className={cn("object-contain object-right translate-y-[40px] md:translate-y-[100px] md:translate-x-[100px] drop-shadow-[0_30px_45px_rgba(1,31,64,.18)] max-w-[400px]", data.slug === "psr-series" && "md:translate-x-[180px] ")}
            />
          </div>
