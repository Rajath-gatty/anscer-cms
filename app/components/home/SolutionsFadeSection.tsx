    ...
    return (
      <div className="mt-12 flex flex-col gap-16">
        {solutions.map((solution) => (
          <StaticSolutionCard key={solution.title} solution={solution} />
        ))}
      </div>
    );
  }
...
function FadeSolutionSlide({
  ...
  return (
    <article
      className="absolute inset-0 grid min-h-[520px] items-start gap-10 bg-[#fafafa] pt-4 transition-opacity duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-opacity lg:grid-cols-[0.42fr_0.58fr]"
      style={{
        opacity,
  ...
  return (
    <article className="relative bg-[#fafafa]">
      ...
      <div className="mt-1 flex items-center gap-3">
        ...
        <h3 className="text-[10px] font-bold uppercase tracking-wide text-[#005ead]">{solution.title}</h3>
      </div>
