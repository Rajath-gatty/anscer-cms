                    ...
                    <div className="overflow-hidden">
                      <div className="pb-4 pt-2">
                        <Link
                          href="/products"
                          onClick={closeMenu}
                          className="flex items-center gap-3 text-[16px] font-bold text-[#011f40] hover:underline"
                        >
                          Robot Overview
                          <ArrowRight
                            aria-hidden="true"
    ...
    <div className="group relative flex h-[60px] items-center">
      ...
      <div className="invisible absolute left-1/2 top-[60px] z-50 w-[400px] -translate-x-1/2 rounded-xl bg-white opacity-0 shadow-[0_18px_45px_rgba(1,31,64,.22)] transition duration-200 group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100">
        <div className="p-5">
          <Link
            href="/products"
            className="group/link flex items-center gap-3 text-xl font-bold text-[#011f40] hover:underline underline-offset-4"
          >
            Robot Overview
            <ArrowRight
              aria-hidden="true"
